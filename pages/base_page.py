...
class BasePage(object):
    ...
    методологии паттерна PageObjectModel. Создан для наследования последующими классами веб-страниц, в свою очередь,
    содержащих методы управления элементами каждой конкретной страницы платформы www.petfriends.skillfactory.ru."""
